              ...
              <ul>
                {rooms.length > 0 ? (
                  rooms.map((room) => (
                    <li
                      key={room.id}
                      className="flex flex-col md:flex-row md:items-center mb-5 border-base-300
                      border p-5 rounded-2xl w-full min-h-60"
                    >
                      <Image
                        ...
                        height={400}
                        quality={100}
                        className="shadow-sm w-full mb-4 md:mb-0 md:w-1/3 md:h-full object-cover
                        rounded-xl"
                      ></Image>
              ...
              <div className="modal-box">
                ...
                <section className="w-full">
                  ...
                  <input
                    ...
                    value={capacity}
                    placeholder="Capacitée de la salle"
                    className="input input-bordered w-full mb-4"
                  />
